      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-24">
          <div className="flex flex-col gap-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed max-w-xs">
              Frontend Web developer focused on clean code, performance, and
        ...
        <div className="mt-16 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-gray-500 text-sm">
          <p>
            ...
            <span className="text-red-400 cursor-pointer">Mortal Dev</span>. All
            rights reserved.
          </p>
          <p className="flex items-center gap-2">
            Made with <span className="text-red-600 animate-pulse">❤️</span> in
            <span className="text-red-400">Uzbekistan</span>
          </p>
        </div>
      </div>
    </footer>
